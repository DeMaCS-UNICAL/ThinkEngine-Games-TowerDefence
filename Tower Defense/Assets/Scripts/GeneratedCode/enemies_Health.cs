...
{
	public class enemies_Health : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "enemies_Health(sensors,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		}
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				for(int i_2 = 0; i_2 < Enemies_2.Count; i_2++)
				{
					...
					int Health_3 = Enemies_2[i_2].Health;
					if (values[i_2].Count == 1)
					{
						values[i_2].RemoveAt(0);
					}
					values[i_2].Add(Health_3);
				}
			}
		}
