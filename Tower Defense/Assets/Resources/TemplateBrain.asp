...
%nodeSensor(node0,objectIndex(X),nodeSensorData(turretTypeName(V))).
%nodeSensor(node0,objectIndex(X),nodeSensorData(x(V))).
%nodeSensor(node0,objectIndex(X),nodeSensorData(y(V))).
